...
extern uint8_t		read_x8(uint32_t addr, int log);
extern uint16_t	read_x16(uint32_t addr, int log);
extern uint32_t	read_x32(uint32_t addr, int log);
extern uint64_t	read_x64(uint32_t addr, int log);
extern uint32_t   read_n(uint32_t addr, uint32_t Size, int log);
